...
CFLAGS = -Wall -Wextra -pthread  # -Wall y -Wextra activan advertencias; -pthread permite el uso de hilos
...
publicadorp: publicadorp.c
	$(CC) $(CFLAGS) -o publicadorp publicadorp.c  # Compila 'publicadorp.c' y genera el ejecutable 'publicadorp'

# Regla para compilar el programa 'suscriptorp_modificado'
suscriptorp_modificado: suscriptorp_modificado.c
	$(CC) $(CFLAGS) -o suscriptorp_modificado suscriptorp_modificado.c  # Compila 'suscriptorp_modificado.c'
...
clean:
	rm -f $(TARGETS)  # Elimina los archivos ejecutables especificados en TARGETS